  ...
  return (
    <article>
      ...
      <p>
        ...
        type de la variable sera automatiquement déterminé lorsque le programme
      ...
      <p>
        ...
        (nombre à virgule). Cependant le nombre pouvant être représenté se place
        entre <span>2^-1074</span> et <span>2^1074</span>, mais le programme
        convertira votre donnée en <span>+Infinity</span> ou{' '}
        <span>-Infinity</span> si il n'est pas entre <span>-(2^53 − 1)</span> et{' '}
        <span>2^53 − 1</span>.
      </p>
      <SyntaxHighlighter language="javascript" style={vscDarkPlus}>
        {`let nb = 8 //Entier\nnb = 8.943 //Flottant`}
      ...
      <p>
        ...
        strictement égal <span>===</span> à un nombre classique, seul l'égalité
        simple <span>==</span> fonctionnera.
      </p>
      <h2>Le type chaîne de caractères</h2>
      <p>
        Ce type JavaScript est utilisé afin de représenter des données de texte.
        Chaque élément occupe une position au sein de cette chaîne de
      ...
      <h2>Les Objets</h2>
      <p>
        En informatique, un objet est une valeur conservée en mémoire à laquelle
        on fait référence grâce à un identifiant.
      </p>
      <p>
        Un objet JavaScript est un ensemble de correspondances entre des clés et
        des valeurs. Les clés sont représentées par des chaînes de caractères.
      ...
      <p>
        Même si cela parait contre-intuitif, la valeur passée à une clé dans un
        objet peut etre de tous types, exactement comme pour une variable (cela
        incluant les tableaux, fonctions, objets... etc.)
      </p>
      <SyntaxHighlighter language="javascript" style={vscDarkPlus}>
