  ...
  return (
    <div>
      ...
      <article>
        ...
        <p>
          <strong>
            En JavaScript, une variable est un conteneur qui va nous permettre
            de stocker des informations.
          </strong>
        </p>
        <p>
          {" "}
          Elles ne servent qu'à stocker temporairement des informations. En
          effet, elles n'existent que durant l'exécution du code JS ; elles ne
          persistent pas dans le temps. Si l'on souhaite sauvegarder durablement
          des informations, il faut se tourner vers une autre méthode : base de
        ...
        <p>
          Comme dans tous les langages de programmation, les variables font
          partie des fondements. Il est essentiel de pouvoir stocker et
          manipuler des variables pour développer les scripts JavaScript. Les
          futures instructions que nous écrirons en JS feront évoluer des
          variables pour répondre au besoin initial. Vous comprendrez mieux
          l'intérêt des variables quand nous commencerons réellement à écrire
          des scripts.
        </p>
      </article>
      <article>
        ...
        <p>
          ...
          temporairement des informations. Chaque variable est identifiée au
          sein du code JS par un nom unique. Cela permet de les distinguer les
          unes des autres et de les utiliser sans problèmes.
        </p>
        ...
        <p>
          ...
          valeur 0. Evidemment une variable ne peut pas avoir n'importe quel
          nom.
        </p>
        <ul>
          <li>Utiliser le mot-clé let avant chaque nom de variable</li>
          <li>
            Le nom d’une variable doit obligatoirement commencer par une lettre
            ou un underscore (_){" "}
          </li>
          <li>
            {" "}
      ...
      <article>
        ...
        <p>
          La valeur d'une variable peut être destinée à changer afin de servir
          le but de l'algorithme. Pas de panique, il est totalement possible de
          réassigner une nouvelle valeur à vos variables déclarées via le
          mot-clef <span>let</span> (Nous reviendrons plus tard sur l'importance
          de bien choisir le mot-clef de la déclaration).
        </p>
        <p>
        ...
        <p>
          ...
          pour réaffecter une variable avec une nouvelle valeur, l'ancienne
          valeur est écrasée par la nouvelle, et est donc{" "}
          <strong>
      ...
      <article>
        ...
        <p>
          La portée d'une variable est décidée par l'endroit dans lequel elle
          est <strong>déclarée</strong> et avec quel <strong>mot-clef</strong>.
        </p>
        <h3>let</h3>
        <p>
        ...
        <p>
          ...
          des réaffectations ultérieures. Une constante ne peut pas être
          déclarée à nouveau.
        </p>
        <SyntaxHighlighter language="javascript" style={vscDarkPlus}>
        ...
        <p>
          Au delà de simplement empêcher la réaffectation de valeurs, la
          mot-clef <span>const</span> lancera une erreur dans la console si une
          tentative de modification de valeur a lieu.
        </p>
      </article>
    </div>
  );
